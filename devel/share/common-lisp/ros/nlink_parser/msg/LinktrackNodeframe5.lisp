...
(cl:defclass <LinktrackNodeframe5> (roslisp-msg-protocol:ros-message)
  ((role
    :reader role
    :initarg :role
    :type cl:fixnum
   ...
   (nodes
    :reader nodes
    :initarg :nodes
    :type (cl:vector nlink_parser-msg:LinktrackNode5)
   :initform (cl:make-array 0 :element-type 'nlink_parser-msg:LinktrackNode5 :initial-element (cl:make-instance 'nlink_parser-msg:LinktrackNode5))))
)

(cl:defclass LinktrackNodeframe5 (<LinktrackNodeframe5>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <LinktrackNodeframe5>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'LinktrackNodeframe5)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nlink_parser-msg:<LinktrackNodeframe5> is deprecated: use nlink_parser-msg:LinktrackNodeframe5 instead.")))

(cl:ensure-generic-function 'role-val :lambda-list '(m))
(cl:defmethod role-val ((m <LinktrackNodeframe5>))
...
(cl:defmethod id-val ((m <LinktrackNodeframe5>))
...
(cl:defmethod local_time-val ((m <LinktrackNodeframe5>))
...
(cl:defmethod system_time-val ((m <LinktrackNodeframe5>))
...
(cl:defmethod voltage-val ((m <LinktrackNodeframe5>))
...
(cl:defmethod nodes-val ((m <LinktrackNodeframe5>))
  ...
  (nodes m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <LinktrackNodeframe5>) ostream)
  "Serializes a message object of type '<LinktrackNodeframe5>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LinktrackNodeframe5>) istream)
  "Deserializes a message object of type '<LinktrackNodeframe5>"
  ...
  (cl:let ((vals (cl:slot-value msg 'nodes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'nlink_parser-msg:LinktrackNode5))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LinktrackNodeframe5>)))
  "Returns string type for a message object of type '<LinktrackNodeframe5>"
  "nlink_parser/LinktrackNodeframe5")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LinktrackNodeframe5)))
  "Returns string type for a message object of type 'LinktrackNodeframe5"
  "nlink_parser/LinktrackNodeframe5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<LinktrackNodeframe5>)))
  "Returns md5sum for a message object of type '<LinktrackNodeframe5>"
  "26bd069cbc20641e42df0ae46b96110c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'LinktrackNodeframe5)))
  "Returns md5sum for a message object of type 'LinktrackNodeframe5"
  "26bd069cbc20641e42df0ae46b96110c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LinktrackNodeframe5>)))
  "Returns full string definition for message of type '<LinktrackNodeframe5>"
  (cl:format cl:nil "uint8 role~%uint32 id~%uint32 local_time~%uint32 system_time~%float32 voltage~%LinktrackNode5[] nodes~%~%================================================================================~%MSG: nlink_parser/LinktrackNode5~%uint8 role~%uint32 id~%float32 dis~%float32 fp_rssi~%float32 rx_rssi~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LinktrackNodeframe5)))
  "Returns full string definition for message of type 'LinktrackNodeframe5"
  (cl:format cl:nil "uint8 role~%uint32 id~%uint32 local_time~%uint32 system_time~%float32 voltage~%LinktrackNode5[] nodes~%~%================================================================================~%MSG: nlink_parser/LinktrackNode5~%uint8 role~%uint32 id~%float32 dis~%float32 fp_rssi~%float32 rx_rssi~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <LinktrackNodeframe5>))
  (cl:+ 0
     1
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <LinktrackNodeframe5>))
  "Converts a ROS message object to a list"
  (cl:list 'LinktrackNodeframe5
