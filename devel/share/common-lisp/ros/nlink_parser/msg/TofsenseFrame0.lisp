...
(cl:defclass <TofsenseFrame0> (roslisp-msg-protocol:ros-message)
  ((id
   ...
   (signal_strength
    ...
    :initform 0)
   (range_precision
    :reader range_precision
    :initarg :range_precision
    :type cl:fixnum
    :initform 0))
)
...
(cl:ensure-generic-function 'range_precision-val :lambda-list '(m))
(cl:defmethod range_precision-val ((m <TofsenseFrame0>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nlink_parser-msg:range_precision-val is deprecated.  Use nlink_parser-msg:range_precision instead.")
  (range_precision m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <TofsenseFrame0>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'range_precision)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TofsenseFrame0>) istream)
  "Deserializes a message object of type '<TofsenseFrame0>"
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'range_precision)) (cl:read-byte istream))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TofsenseFrame0>)))
  ...
  "5579723ab4876e453dd6025247ac5ffb")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TofsenseFrame0)))
  "Returns md5sum for a message object of type 'TofsenseFrame0"
  "5579723ab4876e453dd6025247ac5ffb")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TofsenseFrame0>)))
  ...
  (cl:format cl:nil "uint8 id~%uint32 system_time~%float32 dis~%uint8 dis_status~%uint16 signal_strength~%uint8 range_precision~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TofsenseFrame0)))
  "Returns full string definition for message of type 'TofsenseFrame0"
  (cl:format cl:nil "uint8 id~%uint32 system_time~%float32 dis~%uint8 dis_status~%uint16 signal_strength~%uint8 range_precision~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <TofsenseFrame0>))
  ...
  (cl:list 'TofsenseFrame0
    ...
    (cl:cons ':range_precision (range_precision msg))
))
