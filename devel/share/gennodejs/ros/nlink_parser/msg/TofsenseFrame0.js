...
class TofsenseFrame0 {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('range_precision')) {
        this.range_precision = initObj.range_precision
      }
      else {
        this.range_precision = 0;
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [range_precision]
    bufferOffset = _serializer.uint8(obj.range_precision, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [range_precision]
    data.range_precision = _deserializer.uint8(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.range_precision !== undefined) {
      resolved.range_precision = msg.range_precision;
    }
    else {
      resolved.range_precision = 0
    }
