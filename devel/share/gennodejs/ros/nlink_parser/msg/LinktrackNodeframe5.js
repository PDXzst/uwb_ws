...
class LinktrackNodeframe5 {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.nodes.forEach((val) => {
      bufferOffset = LinktrackNode5.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LinktrackNodeframe5(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.nodes[i] = LinktrackNode5.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LinktrackNodeframe5(null);
    ...
    if (msg.nodes !== undefined) {
      ...
      for (let i = 0; i < resolved.nodes.length; ++i) {
        resolved.nodes[i] = LinktrackNode5.Resolve(msg.nodes[i]);
      }
    }
    else {
      resolved.nodes = []
...
module.exports = LinktrackNodeframe5;
